      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            subtitle: Text('custom.disable_latest_version'.tr),
          ),
          // FutureBuilder(
          //   future: c.isLogin()
          ...
          ListTile(
            leading: Icon(MdiIcons.github),
            title: Text('custom.original_author'.tr),
            onTap: () => launchUrlString(originalAuthorLink),
            subtitle: const Text(originalAuthorLink),
          ),
          // ListTile(
